...
class Command(BaseCommand):
    ...
    help = "Check all process, remind uncompleted assigned tasks"
    ...
    def handle(self, *args, **options):
        ...
        query = dict(
            # Should filter for Process with officer intervention
            #   DisciplinaryProcessFlow, resignation, osm, convention

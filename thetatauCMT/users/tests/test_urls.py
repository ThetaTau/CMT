...
class TestUserURLs(TestCase):
    ...
    def test_detail_reverse(self):
        """users:detail should reverse to /users/myinfo/."""
        self.assertEqual(reverse("users:detail"), "/users/myinfo/")

    def test_detail_resolve(self):
        """/users/myinfo/ should resolve to users:detail."""
        self.assertEqual(resolve("/users/myinfo/").view_name, "users:detail")
